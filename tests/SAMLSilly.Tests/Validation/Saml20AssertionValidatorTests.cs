...
namespace SAMLSilly.Tests.Validation
{
    ...
    public class Saml20AssertionValidatorTests
    {
        ...
        public class ValidateAssertionAttributesMethod
        {
            ...
            /// </summary>
            [Fact]
            //ExpectedMessage = "Assertion element must have the ID attribute set."
            ...
            /// </summary>
            [Fact]
            //ExpectedMessage = "NameID element has Format attribute which is not a wellformed absolute uri."
            ...
            /// </summary>
            [Fact]
            //ExpectedMessage = "Assertion element must have the IssueInstant attribute set."
            ...
            /// </summary>
            [Fact]
            //ExpectedMessage = "Wrong value of version attribute on Assertion element"
        ...
        public class ValidateValidateConditionsMethod
        {
            ...
            /// </summary>
            [Fact]
            //ExpectedMessage = "Count attribute of ProxyRestriction MUST BE a non-negative integer"
            ...
            /// </summary>
            [Fact]
            //ExpectedMessage = "ProxyRestriction Audience MUST BE a wellformed uri"
        ...
        public class ValidateTimeRestrictionsMethod
        {
            ...
            /// </summary>
            [Fact(Skip = "TODO: test data needs fixing (was also ignored in Hg)")]
            //ExpectedMessage = "AuthnStatement attribute SessionNotOnOrAfter MUST be in the future"
            ...
            /// </summary>
            [Fact]
            //ExpectedMessage = "Conditions.NotOnOrAfter must not be in the past"
        ...
        public class ValidateConditionsIntervalMethod
        {
            ...
            /// </summary>
            [Fact]
            //ExpectedMessage = "Conditions.NotBefore must not be in the future"
